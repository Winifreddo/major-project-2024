    ...
    <div className="flex flex-col p-2">
      <div className="flex text-xs">
        <p className="font-thin italic py-2">
          <Link href="/">Home</Link>/
          <Link href={`/shop/${product.category}?category=${product.category}`}>
            {product.category}
          </Link>
        </p>{" "}
      </div>
      <hr className="opacity-20" />
      <h1 className="py-2 md:py-6 font-poppins font-bold text-2xl md:text-4xl">
  ...
  size       */}
      ...
      <form className="flex flex-col">
        ...
        <select
          name="quantity"
          id="quantity"
          className="bg-white outline-smokeGrey py-3 px-4 my-3"
        >
        ...
        <button
          type="submit"
          className="bg-smokeGrey py-2 text-white  hover:bg-salmonPink hover:text-smokeGrey rounded-md mb-3"
        >
          Add to cart
        </button>
      </form>
      ...
      <div className="grid md:grid-cols-4 grid-cols-2 text-center place-items-center gap-1 my-4 mb-6 font-thin">
        <div className="w-full h-full bg-salmonPink p-6 rounded-t-full">
        ...
        <div className="w-full h-full bg-darkPink p-6 rounded-t-full">
        ...
        <div className="w-full h-full bg-stoneMedium p-6 rounded-t-full">
          {" "}
          <div className="w-full  flex justify-center">
        ...
        <div className="w-full h-full bg-mossGreen p-6 rounded-t-full ">
          <div className="w-full flex justify-center">
