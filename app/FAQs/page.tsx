  ...
  return (
    <>
      <header className="w-full flex md:flex-row flex-col justify-stretch bg-smokeGrey p-12">
        ...
        <h1 className="text-stoneMedium text-xl p-2">RE-FORM</h1>
        <h2 className="w-full text-stoneMedium text-center text-7xl font-poppins font-bold">
          {" "}
          US
        </h2>
      ...
      <section className="grid md:grid-cols-2 grid-cols-1 w-full h-full place-items-center text-center">
        <div className="flex  items-center justify-center bg-mossGreen text-stoneDark p-16 h-screen w-full ">
          <Image
        ...
        <div className="bg-stoneDark text-mossGreen w-full p-16 h-screen flex flex-col items-center justify-center">
          <p className=" leading-loose p-12  text-3xl font-poppins font-thin">
        ...
        <div className="bg-stoneDark text-mossGreen w-full h-screen p-16 flex flex-col items-center justify-center">
          <h3 className="font-poppins font-bold text-center text-5xl">
            WHO WE ARE
          </h3>
          <p className=" leading-loose py-4 px-16 font-poppins text-xl font-thin">
        ...
        <div className="bg-darkPink w-full h-screen p-16 flex items-center justify-center">
          <Image
      ...
      <section>
        <div className="flex flex-col items-center justify-center bg-smokeGrey text-stoneDark p-12 w-full ">
          <p className=" leading-loose py-4 px-16 font-poppins text-2xl font-thin">
            <span className="F">
              <i>F</i>
            </span>
      ...
      <section className="grid md:grid-cols-2 grid-cols-1 w-full h-full place-items-center text-center">
        ...
        <div className="bg-stoneDark text-mossGreen w-full p-16 h-screen flex flex-col items-center justify-center">
          ...
          <p className=" leading-loose p-12  text-xl font-poppins font-thin">
      ...
      <section>
        <div className="w-full bg-smokeGrey  flex flex-col items-center justify-center">
          <h3 className="font-poppins font-bold text-stoneDark pt-4 text-center text-5xl">
